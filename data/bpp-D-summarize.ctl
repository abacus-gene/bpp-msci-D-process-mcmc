      ...
      Imapfile = h_mel_tim_num_imap.txt
       outfile = out.txt
      mcmcfile = h_mel_tim_num_noncod_mcmc_L500_small_processed.txt
*      mcmcfile = h_mel_tim_num_noncod_mcmc_L500_small_processed_CoGN.txt
*      mcmcfile = h_mel_tim_num_noncod_mcmc_L500_small_processed_CoG0.txt
