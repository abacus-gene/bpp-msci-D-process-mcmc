       ...
       seqfile = h_mel_tim_num_exonic.txt
      Imapfile = h_mel_tim_num_imap.txt
       outfile = h_mel_tim_num_exonic_out_L500_small.txt
      mcmcfile = h_mel_tim_num_exonic_mcmc_L500_small.txt
...
species&tree = 3 M T N
       ...
       usedata = 1  * 0: no data (prior); 1:seq like
         nloci = 3023 * 500 * 36138 autosomal exonic loci, 3023 on chr1
